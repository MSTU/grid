# coding=Windows-1251
#HELP<model name="ValveUnversal" module="EngineLib" alias = "VALVEU" ext="5" par="1" vpr = "1" adr="2" ign ="3" wrk = "10">   
#HELP	<description>
#HELP		<russian>
#HELP 		Клапан 
#HELP		</russian>
...
#  //Flow functions
#  flowSubsonic =sqrt(gamma)*(2/(gamma + 1))^((gamma + 1)/(2*(gamma - 1)));
#  flowSupersonic =((p_out/p)^(1/gamma))*sqrt((2*gamma/(gamma - 1))*(1 - (p_out/p)^((gamma - 1)/gamma)));
#  p_critical =p*(2/(gamma + 1))^(gamma/(gamma - 1));
