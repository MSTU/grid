...
#		print 'Shape =',Shape
		...
		h4 = math.sqrt( (pM[0]-pD[0])**2  + (pM[1]-pD[1])**2+(pM[2]-pD[2])**2)/20.0
		...
		SV3DK4 = Model('Links.SV3DK',[_net9,_net0],[pD, pM, pX, G, G, T, G], desc = misc.ppl_scheme_desc(desc,'SV3DK4') )
...
#		MJ3D1_image = misc.AddImage('Images.ELP3D', MJ3D1, [ pM,  pA,  pX,  h,h,h,    5,    5],['yellow', 'Plastic', 0.0], desc = misc.ppl_scheme_desc(desc,'Mass') )
		...
		Point2XYZs5 = pradis.splitters.Point2XYZs.Point2XYZs([_net9,_net10,_net4], [], desc = misc.ppl_scheme_desc(desc,'Point2XYZs5') )
